...
export default function PortfolioScreen() {
  const openGithub = () => {
    Linking.openURL('https://github.com/MarkathanManalang');
  };
  ...
  const openSourceCode = () => {
    Linking.openURL('https://github.com/MarkathanManalang/react.js-crud');
  };

  const openEmail = () => {
    Linking.openURL('manalangmark95@gmail.com');
  };
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>Mark Athan</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.contactGrid}>
          <TouchableOpacity style={styles.contactCard} onPress={openEmail}>
            ...
            <Text style={styles.contactDetail}>manalangmark95@gmail.com</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>© 2025 Mark. Built with React Native & Expo</Text>
      </View>
    </ScrollView>
  );
}
